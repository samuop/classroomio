...
- **A picture of the correct state is teaching, not decoration.** When the lesson teaches what something must LOOK like when it is done right — goods grouped by family on a shelf, a notice board written large and clean, a work area left tidy for the next shift, equipment covered and protected — a picture of that finished state shows the standard better than any description, and the learner can hold it up against what is in front of them. Say in the HTML beside it what makes it correct; the picture shows, the text names.
- **Do NOT use it for anything structural:** charts, graphs, flows, timelines, hierarchies, labelled parts, process steps, decision rules, anything carrying data. Those stay inline \`<svg>\` — sharper, editable by the teacher afterwards, and free. (A picture of a physical result, as above, is not structural: it has no boxes and no labels in it.)
