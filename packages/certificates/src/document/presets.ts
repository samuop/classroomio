...
function classiquePreset(design: CertificateDesign): CertificateDocument {
  ...
  const elements: CertificateElement[] = [
    ...
    text({
      ...
      w: 920,
      h: 26,
      content: labels.presented ? `— ${labels.presented} —` : '',
    ...
    text({
      ...
      w: 700,
      h: 116,
      content: design.descriptionOverride || '{{courseDescription}}',
      family: 'Cormorant Garamond',
      size: 18,
      color: '#3a2515',
      italic: true,
  ...
  return {
    ...
    elements: [
      ...
      text({
        ...
        w: 420,
        h: 20,
        content: `${labels.reference}: {{certificateId}}`,
        family: 'DM Mono',
        size: 11,
        color: '#666666',
        align: 'right'
